...
<tr>
<td width="10%"><img src="<%=contextpath %>/images/cris_logo.jpg?OpenImageResource" width="90%" height="90%"></td>
...
<td class="alignment-center" width="10%"><img src="<%=contextpath %>/images/mcf_logo.jpg?OpenImageResource" width="90%" height="80%"></td></tr>
