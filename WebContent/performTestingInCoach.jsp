...
<div id="furnishingproduction" style="border:1px solid black;margin:7px;height:100%;width:100%;display:none;z-index:9;">
<form name="furnishingprodform" >

<h1 align="center"style="font-size:20px;">SELF INSPECTION PROFARMA</h1>
<h2 align="center" style="font-size:15px;">FIRE,SMOKE DETECTION AND SUPPRESSION SYSTEM</h2> 
<table border=1 style="width:98%;float:center;">
<tr>
<td style="width:10%;text-align:center;"><b>Shell Type:</b></td>
<td style="width:10%"><input type="text" name="shelltype" id="shelltype" style="border:none;" size="5" placeholder="shelltype" ></td>
<td style="width:10%;text-align:center;"><b>Shell No.:</b></td>
<td style="width:10%"><input type="text" name="shellno" id="shellno" style="border:none;" size="5" placeholder="shellno"></td>
<td style="width:10%;text-align:center;"><b>Doc No.:</b></td>
<td style="width:30%"><input type="text" name="docnofiresmoke" id="docnofiresmoke" style="border:none;" size="50" placeholder="docno" class='validate[required]'></td>
</tr>
</table>
<br>
<table border=1 style="width:98%;float:center;">
<tr>
<td style="width:5%;text-align:center;"><b>DATE :</b></td>
<td style="width:10%"><input type="text" name="dateoffiresmoke" id="dateoffiresmoke" style="border:none;" size="10" class='validate[required]'></td>
<td style="width:5%;text-align:center;"><b>SHIFT :</b></td>
<td style="width:10%"><select name="shiftfiresmoke" id="shiftfiresmoke" style="border:none;width:60%" class='validate[required]'>
<option value="">Select</option>
<option value="general">General</option>
<option value="morning">Shift-I</option>
<option value="evening">Shift-II</option>
...
<td style="width:10%;text-align:center;"><b>SUPPLIER NAME :</b></td>
<td style="width:10%"><input type="text" name="suppname" id="suppname" style="border:none;" placeholder="SUPPLIER NAME" class='validate[required]'></td>
</tr>
</table>
<br>
<table border=1 style="width:98%;float:center;">
...
<td style="width:10%;text-align:center;"><b>COACH TYPE :</b></td>
<td style="width:10%"><input type="text" name="coachtype" id="coachtype" style="border:none;" placeholder="COACH TYPE" size="10" readonly></td>
<td style="width:10%;text-align:center;"><b>COACH No.:</b></td>
<td style="width:10%"><input type="text" name="coachno" id="coachno" style="border:none;" placeholder="COACH No."></td>
<td style="width:15%;text-align:center;"><b>Furnishing No. :</b></td>
<td style="width:10%"><input type="text" name="furno" id="furno" style="border:none;" placeholder="Furno" size="10"></td>
</table>
<br>
<table border=1 cellspacing=0 cellpadding=0 style="width:100%">
<tr>
                            ...
                            $('#dateofbuffercbcheighttesting').datepicker('option', 'minDate', new Date(record.assemblyStartDate));
                             $("#furnishingproduction").dialog({
                             ...
                             
                                        {
                                            ...
                                            {
                                            	icon: '<%=contextpath%>/images/rs_out.png',
                                                text: 'Fire,Smoke Detection And Suppression System',
                                                click: function () {
                                                 var $selectedRows = $('#FurnishingProductionTableContainer').jtable('selectedRows');
                                                if ($selectedRows.length<1)
                                               alert("Please select a row for which you want to Fill SIP Data");
                        							 ...
                        							 $.ajax({
                        									url: "showexistingdataoffiresmoke",  //fecth data code
                        									type:'POST',
                        									async:false,
                        									data:
                        										{
                        								...
                        								success:function(msg)
                        								{
                        									$('#docnofiresmoke').val(msg.docnofiresmoke),
                        								    $('#shelltype').val(msg.shelltype),
                        								    $('#shellno').val(msg.shellno),
                        									$('#coachtype').val(msg.coachtype),
                        									$('#coachno').val(msg.coachno),
